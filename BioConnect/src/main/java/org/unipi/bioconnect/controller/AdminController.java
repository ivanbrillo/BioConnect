...
public class AdminController {
    ...
    public UserDTO getUserByUsername(
            @Parameter(
                    description = "The username of the user to retrieve details", example = "test_user1",
    ...
    public String removeComment(
            @Parameter(
                    description = "The unique ID of the user who made the comment", example = "test_user1",
                    required = true, schema = @Schema(type = "string")
            ) @PathVariable String user,
            @Parameter(
                    description = "The unique ID of the comment to be removed", example = "0a5f1499-f0b3-4342-91da-f7f3858ebc43",
                    required = true, schema = @Schema(type = "string")
    ...
    public String removeUser(
            @Parameter(
                    description = "The unique ID of the user to delete", example = "test_user1",
                    required = true, schema = @Schema(type = "string")
            ) @PathVariable String user) {
